...
**Conference**
- Reusing the Task-specific Classifier as a Discriminator: Discriminator-free Adversarial Domain Adaptation [[CVPR2022]](https://openaccess.thecvf.com/content/CVPR2022/papers/Chen_Reusing_the_Task-Specific_Classifier_as_a_Discriminator_Discriminator-Free_Adversarial_Domain_CVPR_2022_paper.pdf) [[Pytorch]](https://github.com/xiaoachen98/DALN)  (**No** supplementary materials, so the setup details for expriments can't be found, which means I can't reproduce the entire experiment. Only GRL and NWD --2 parts of the program could be found in the link.)
...
- Cross-Domain Document Object Detection: Benchmark Suite and Method [[CVPR2020]](http://openaccess.thecvf.com/content_CVPR_2020/papers/Li_Cross-Domain_Document_Object_Detection_Benchmark_Suite_and_Method_CVPR_2020_paper.pdf) [[code]](https://github.com/kailigo/cddod) --(**No**--part codes and datasets)
...
- PointDAN: A Multi-Scale 3D Domain Adaption Network for Point Cloud Representation [[NeurIPS 2019]](https://arxiv.org/abs/1911.02744v1) [[code]](https://github.com/canqin001/PointDAN)  --(ScanNet **dataset is hard to get**, it needs a guarantee to send to email. But this expriment is hopeful to reproduce. It worth a try.)
